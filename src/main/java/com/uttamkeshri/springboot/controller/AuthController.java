...
import com.uttamkeshri.springboot.exception.AppException;
...
import com.uttamkeshri.springboot.payload.JwtAuthenticationResponse;
...
import com.uttamkeshri.springboot.security.JwtTokenProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getName(), signUpRequest.getUsername(),
                signUpRequest.getAddress(), signUpRequest.getEmail(), signUpRequest.getMobile(), signUpRequest.getPassword());
